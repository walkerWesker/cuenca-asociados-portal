...
export const servicesData = [
  ...
  },
  {
    ...
    description: 'Administración integral de la contabilidad financiera de la empresa, garantizando registros precisos y cumplimiento normativo.',
    icon: FileCheck,
    details: [
      'Procesamiento y análisis de la información contable y financiera de la empresa',
      'Elaboración de estados financieros mensuales, trimestrales y anuales según normas contables vigentes',
      'Registro de operaciones contables (ingresos, gastos, activos, pasivos) con conciliación bancaria',
      'Gestión de cuentas por cobrar y por pagar, así como provisiones y depreciaciones de activos',
      'Implementación y soporte de sistemas contables adaptados a las necesidades de la empresa'
    ],
  ...
  },
  {
    ...
    description: 'Levantamiento físico y control de activos fijos para asegurar la correcta gestión patrimonial y cumplimiento contable.',
    icon: ClipboardList,
    details: [
      'Identificación y codificación de activos fijos existentes en la empresa',
      'Verificación física y conciliación con registros contables',
      'Etiquetado con código de barras o RFID para trazabilidad',
      'Registro de ubicación, estado y responsable de cada activo',
      'Generación de informes detallados y reportes de hallazgos',
      'Asesoría en la actualización de políticas de control de activos',
      'Cumplimiento de normativas contables y auditorías internas'
    ],
